...
public class INN {
    ...
    public static void main(String[] args) {
        ...
        INNBase.put("0567475944", "Пупкин Василий Петрович");
        INNBase.put("7992222888", "Путим Владимир Владимирович ");
        INNBase.put("3401662695", "Иосиф Висарионович Сталин ");
        INNBase.put("0204012893", "Медведев Анатолий Дмитриевич");
